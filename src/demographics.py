...
- swap_demographics(): rewrite gender/age cues for counterfactual variants.
- mask_demographics(): neutralize gender/age cues for C3 (RAG + masking).

MIMIC de-identifies ages as '___', so explicit ages are rare; the main cues are
titles (Mr./Ms.), pronouns, sex words (man/woman), and 'M'/'F' shorthand.
"""
import re
...
# Relationship words (husband, mother, ...) describe other people and are left unchanged.
# 'her' is ambiguous (him/his); map to 'his' before a noun-ish word, else 'him'
...
# e.g. "___ M", "___ y/o F", "65 yo man", "65-year-old", "65M", "w/"
# (a bare number before M/F is NOT matched, to avoid temperatures like "101 F")
...
def _her_is_possessive(text: str, m) -> bool:
    """'her pain' -> possessive; 'wake her.' / 'gave her to' -> object."""
